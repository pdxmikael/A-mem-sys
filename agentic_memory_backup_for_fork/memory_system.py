...
# from transformers import AutoModel, AutoTokenizer  # Temporarily disabled
...
class AgenticMemorySystem:
    ...
    def __init__(self, 
        ...
        # Create a fresh retriever instance with persistence
        self.retriever = ChromaRetriever(collection_name="memories", model_name=self.model_name, persist_directory="./memory_db")
    ...
    def consolidate_memories(self):
        ...
        # Reset ChromaDB collection with persistent storage
        self.retriever = ChromaRetriever(collection_name="memories", model_name=self.model_name, persist_directory="./memory_db")
